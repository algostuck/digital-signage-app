...
PLANS = [
    ...
    },
    {
        ...
        "prices": {
            "monthly": {"amount": 14999, "currency": "INR"},
    ...
    },
    {
        ...
        "prices": {
            "monthly": {"amount": 49999, "currency": "INR"},
    ...
    },
    {
        ...
        "entitlements": {
            "max_devices": 5000,
            "max_users": 500,
            "max_storage_mb": 5120000,
            "max_locations": 5000,
            "max_api_calls_month": None,
    ...
    if admin is None:
        ...
        if not password:
            if get_settings().is_production:
                raise RuntimeError(
                    "SEED_PLATFORM_PASSWORD must be set to seed the platform "
                    "administrator in production; the development default is refused."
                )
            password = "Platform@12345"  # noqa: S105 - documented development default
        admin = User(
            organization_id=org.id,
